    ...
    <>
      <ScrollView>
        <View style={styles.main}>
          <Button title="Return to List" onPress={() => navigation.popToTop()} color="#fff" />
        </View>
        <View style={styles.main}>
          ...
          <View style={styles.container}>
            ...
            <View>
              {targetPockemon &&
                targetPockemon.abilities &&
                targetPockemon.abilities.map((ab, index) => {
                  return (
          ...
          <View style={styles.container}>
            ...
            <View>
              <Text style={styles.rightText}>{targetPockemon?.base_experience}</Text>
            </View>
          </View>

          <View style={styles.container}>
            <View style={styles.leftItem}>
              <Text style={styles.leftText}>Moves:</Text>
            </View>
            <View>
              {targetPockemon &&
                targetPockemon.moves &&
                targetPockemon.moves.map((item, index) => {
                  return (
                    <Text key={index} style={styles.rightText}>
                      {item.move.name}
                    </Text>
